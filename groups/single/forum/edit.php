	...
	<form action="<?php bp_forum_topic_action(); ?>" method="post" id="forum-topic-form" class="standard-form">
		...
		<div class="item-list-tabs" id="subnav" role="navigation">
			<ul>
				...
				<li>
					<a href="#post-topic-reply"><?php _e( 'Reply', 'bp-default' ); ?></a>
				</li>
		...
		<div id="topic-meta">
			...
			<h3><?php _e( 'Edit:', 'bp-default' ); ?> <?php bp_the_topic_title(); ?> (<?php bp_the_topic_total_post_count(); ?>)</h3>
		...
		<?php if ( bp_is_edit_topic() ) : ?>
			...
			<div id="edit-topic">
				...
				<label for="topic_title"><?php _e( 'Title:', 'bp-default' ); ?></label>
				<input type="text" name="topic_title" id="topic_title" value="<?php bp_the_topic_title(); ?>" maxlength="100" />

				<label for="topic_text"><?php _e( 'Content:', 'bp-default' ); ?></label>
				...
				<p class="submit"><input type="submit" name="save_changes" id="save_changes" value="<?php esc_attr_e( 'Save Changes', 'bp-default' ); ?>" /></p>
...
<?php else: ?>
	...
	<div id="message" class="info">
		<p><?php _e( 'This topic does not exist.', 'bp-default' ); ?></p>
	</div><!-- #message -->
