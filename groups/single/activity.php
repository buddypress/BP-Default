<?php
/**
 * BuddyPress - Group - Activity Stream
 * 
 * @package BuddyPress
...
<div class="item-list-tabs no-ajax" id="subnav" role="navigation">
	<ul>
		...
		<li class="feed"><a href="<?php bp_group_activity_feed_link(); ?>" title="<?php esc_attr_e( 'RSS Feed', 'bp-default' ); ?>"><?php _e( 'RSS', 'bp-default' ); ?></a></li>
