<?php
/**
 * BuddyPress - Users Messages Notices
 * 
 * @package BuddyPress
		...
		<?php while ( bp_message_threads() ) : bp_message_thread(); ?>
			...
			<tr id="notice-<?php bp_message_notice_id(); ?>" class="<?php bp_message_css_class(); ?>">
				...
				<td width="21%">
					...
					<span class="activity"><?php _e( 'Sent:', 'bp-default' ); ?> <?php bp_message_notice_post_date(); ?></span>
				</td>
				...
				<td width="10%">
					...
					<a class="button" href="<?php bp_message_notice_delete_link(); ?>" class="confirm" title="<?php esc_attr_e( "Delete Message", "bp-default" ); ?>">x</a>
				</td>
...
<?php else: ?>
	...
	<div id="message" class="info">
		<p><?php _e( 'Sorry, no notices were found.', 'bp-default' ); ?></p>
	</div><!-- #message -->
