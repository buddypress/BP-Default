<?php
/**
 * BuddyPress - Users Capability Settings
 *
 * @package BuddyPress
		...
		<div id="content">
			<div class="padder">
				...
				<div id="item-body" role="main">
					...
					<h3><?php _e( 'Capabilities', 'bp-default' ); ?></h3>
					...
					<form action="<?php echo bp_displayed_user_domain() . bp_get_settings_slug() . '/capabilities/'; ?>" name="account-capabilities-form" id="account-capabilities-form" class="standard-form" method="post">
						...
						<label>
							<input type="checkbox" name="user-spammer" id="user-spammer" value="1" <?php checked( bp_is_user_spammer( bp_displayed_user_id() ) ); ?> />
							 <?php _e( 'This user is a spammer.', 'bp-default' ); ?>
						</label>

						<div class="submit">
							<input type="submit" value="<?php esc_attr_e( 'Save', 'bp-default' ); ?>" id="capabilities-submit" name="capabilities-submit" />
						</div><!-- .submit -->
